...
function Navbar() {
  //console.log("navbar rendered");
    ...
    <Link to="/" className="navbar-brand">
      <img id="nav-logo" src="https://image.shutterstock.com/image-vector/food-logo-icon-design-vector-600w-1690192627.jpg" alt="nav-logo" className="img-fluid d-inline-block align-baseline me-2" />
      <span className="nav-title">Foodico</span>
    </Link>
